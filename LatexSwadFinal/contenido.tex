...
\textbf{Redis Stack} actúa como almacén del caché semántico, puesto que es una extensión de la base de datos Redis que facilita tratar datos complejos como estos. LiteLLM, a través de su módulo \texttt{RedisSemanticCache}, crea automáticamente un índice vectorial en Redis y almacena las respuestas generadas. Ante búsquedas de similitud, Redis devuelve la respuesta más cercana si supera el umbral anteriormente mencionado.
