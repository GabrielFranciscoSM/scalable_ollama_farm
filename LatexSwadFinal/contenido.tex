...
\begin{enumerate}
    ...
    \item \textbf{Detección de cuellos de botella}: mediante pruebas de carga con Locust, que se basa en Python como el test utilizado, podríamos hacernos una idea de los límites del sistema e identificar qué mejorar.
