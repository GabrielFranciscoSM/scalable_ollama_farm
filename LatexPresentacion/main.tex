...
\begin{table}[H]
    ...
    \begin{tabular}{p{10cm}}
        ...
        \textbf{Cumplido}  \\
        \midrule
        Aceleración de 191.5x en latencia con caché. \\
        Buena detección de paráfrasis -- vocabulario diferenciado.   \\ 
        Balanceo equitativo. \\
        Cambios en la configuración independientes y sencillos. \\ 
        Puede atender al menos 2 pets/s. \\ 
        \bottomrule
    \end{tabular}
...
\begin{frame}{Conclusiones}{Limitaciones}
\begin{table}[H]
    \centering
    ...
    \begin{tabular}{p{10cm}}
        ...
        \textbf{Limitación}  \\
        \midrule
        El umbral fijo no se adapta completamente.\\ 
        En ciencia; por ejemplo; no.    \\
        Contamos solo con 2 réplicas de inferencia.   \\ 
        La latencia se limita por CPU y consultar caché. \\
        \bottomrule
    \end{tabular}
...
\begin{frame}{Conclusiones}{Trabajo futuro I}
\begin{itemize}
...
\begin{frame}{Conclusiones}{Trabajo futuro II}
